...
func RenderClusterManifests(params *api.ClusterParams, pullSecretFile, outputDir string, externalOauth bool, includeRegistry bool) error {
...
func (c *clusterManifestContext) setupManifests(externalOauth bool, includeRegistry bool) {
	c.kubeAPIServer()
