...
replace (
	...
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.28.10
	k8s.io/endpointslice => k8s.io/endpointslice v0.28.10
	k8s.io/klog/v2 => k8s.io/klog/v2 v2.110.1
	k8s.io/kms => k8s.io/kms v0.28.10
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.28.10
	k8s.io/sample-controller => k8s.io/sample-controller v0.28.10
